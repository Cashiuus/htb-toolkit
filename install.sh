...
CONFIG_HOME="${HOME}/.config/redcell"
...
cp -n "${APP_BASE}/config/nmap-thermo.xsl" "${CONFIG_HOME}/"



[[ -d "/usr/share/wordlists" ]] && ln -s "${APP_BASE}/wordlists" /usr/share/wordlists/wordlists-redcell



# Run bootstrap-for-pentest to setup our system, if this is reliable to run on various system types
#. "${APP_BASE}/preparation/bootstrap-for-pentest.sh"

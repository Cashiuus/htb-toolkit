...
tmux send-keys -t $SESSION:3.0 "ssh -D 1080 -i /home/cashiuus/htb/lab-dante/creds/id_rsa-katwamba-dc01 katwamba@172.16.1.20"
...
tmux send-keys -t $SESSION:3.2 'sudo sshuttle -r root@10.10.110.100 172.16.1.0/24 -e "ssh -i /home/cashiuus/htb/lab-dante/creds/100-root-id_rsa"'
